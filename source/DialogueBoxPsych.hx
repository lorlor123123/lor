...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	function addCharacter(char:FlxSprite, name:String) {
		switch(name) {
			case 'bf':
				...
				char.animation.addByPrefix('talkIdle', 'BF.png', 24, true); //Dialogue ended
				char.animation.addByPrefix('talk', 'BF.png', 24, true); //During dialogue
				char.flipX = !char.flipX;
				char.y += 140;

			case 'gf':
				char.frames = Paths.getSparrowAtlas('dialogue/GF');
				char.animation.addByPrefix('talkIdle', 'GF.png', 24, true); //Dialogue ended
				char.animation.addByPrefix('talk', 'GF.png', 24, true); //During dialogue
				char.y += 140;
			...
			case 'philip':
				char.frames = Paths.getSparrowAtlas('dialogue/Philip');
				char.animation.addByPrefix('talkIdle', 'Philip.png', 24, true); //Dialogue ended
				char.animation.addByPrefix('talk', 'Philip.png', 24, true); //During dialogue
				char.y += 140;
	...
	public function new(?dialogueList:Array<String>, song:String)
	{
		...
		bgFade = new FlxSprite(-511100, -501110).makeGraphic(FlxG.width * 2, FlxG.height * 2, FlxColor.WHITE);
